 ...
 * Renders inside the public layout (with Header & Footer)
 * for any unmatched routes within a locale
 */
...
export default async function NotFoundCatchAll() {
  ...
  return (
    <section className="flex-1 flex items-center justify-center bg-gradient-to-b from-[#FDFBF7] to-[#F5F0E8]">
